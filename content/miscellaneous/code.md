...
<section>
  <h2>HyperBloch</h2>
  <p>Mathematica package to generate hyperbolic Bloch Hamiltonian of a prescribed tight-binding model on a specified unit cell or supercell, which also support diverse visualization of hyperbolic models. It uses as input the data generated by the HyperCells package. Check out detailed information on the dedicated <a href="https://www.hypercells.net/index.html">website</a> that includes tutorials.</p>
