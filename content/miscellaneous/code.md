...
<section>
  ...
  <p>The data below plot the Euler curvature computed from first principles near two pair of band nodes of $\textrm{ZrTe}$. The bands nodes are stable in the top scenario, and annihilate in the second scanario – even though no difference is visible in the Berry phase and Chern numbers of the nodes.</p>
  </p>
